...
# === Fonction d’envoi LoRaWAN (downlink) ===
def send_downlink(device_id, payload_hex):
    topic = f"v3/rt-ttn-app@ttn/devices/{device_id}/down/push"
    payload = {
        "downlinks": [{
    ...
    print(f"📤 Downlink envoyé à {device_id} : {payload_hex}")
